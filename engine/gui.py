...
class GUI:
    ...
    def undo(self):
        ...
        if len(self.histories) == 1:
            ...
            return
        if (
            len(self.histories) == 2
            and self.cfg.GAME.FIRST_PLAYER not in self.human_players
        ):
            print("no turn to undo")
            return
    ...
    def _display_button(self):
        ...
        ## background
        undo_region = (border, border, border + button_size, border + button_size)
    ...
    def _display_background(self):
        ...
        for _ in range(board_size - 1):
            # Horizontal line
            screen.create_line(line_range[0], shift, line_range[1], shift, fill="#111")

            # Vertical line
            screen.create_line(shift, line_range[0], shift, line_range[1], fill="#111")
