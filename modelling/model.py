...
class Resnet(BaseModel):
    def __init__(self, game, cfg):
        ...
        self.policy_head = PolicyHead(base_channel, H, W, num_actions, drop_rate)
...
class PolicyHead(nn.Module):
    def __init__(self, in_channels, H, W, num_actions, drop_rate=0.0):
...
class ValueHead(nn.Module):
    def __init__(self, in_channels, H, W, drop_rate=0.0):
